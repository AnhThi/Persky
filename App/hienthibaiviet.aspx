<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="hienthibaiviet.aspx.cs" Inherits="hienthibaiviet" %>
    ...
    <div class="container" style="margin-top: 80px;">
        <div class="row">
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <asp:DataList ID="dtl_baiviet" runat="server" RepeatColumns="1">
                    <ItemTemplate>
                        <h2><%# Eval("tieude") %></h2>
                        <small><%# "Đăng vào lúc " + Eval("ngaydang") %></small>
                        <p><%# Eval("noidung") %></p>
                    </ItemTemplate>
                </asp:DataList>                  
            </div>
